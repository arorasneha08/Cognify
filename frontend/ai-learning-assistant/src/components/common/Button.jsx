...
const Button = ({children , onClick , type = 'button', disabled = false , className = "" , variant = "primary" , size = "md"}) => {
  ...
  const variantStyles = {
    primary : "bg-gradient-to-r from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25 hover:from-emerald-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25 hover:from-emerald-600 hover:to-teal-600 hover:shadow-emerald-500/30",
