  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 h-screen w-64 bg-white border-r z-50 transition-transform duration-300 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} border-slate-200 md:translate-x-0 flex flex-col`}
      >
        {/* logo */}
